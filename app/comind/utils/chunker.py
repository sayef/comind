...
class CodeChunker:
    ...
    def chunk_by_functions(self, content: str, symbols: List[dict]) -> List[Tuple[str, int, int, str]]:
        """
...
def chunk_file(
    ...
    if symbols:
        ...
        return [(chunk, start, end, "") for chunk, start, end in chunker.chunk_by_lines(content, file_path)]
