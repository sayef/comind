...
class CodeSnippetExtractor:
    ...
    async def extract_snippet(self, symbol: Symbol, context_lines: int = None) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"error": f"File not found: {symbol.file_path}", "code": "", "file_path": symbol.file_path}
    ...
    async def extract_usage_examples(self, symbol: Symbol, max_examples: int = 3) -> List[Dict[str, Any]]:
    ...
    def _find_function_usages(self, symbol: Symbol, lines: List[str], max_examples: int) -> List[Dict[str, Any]]:
    ...
    def _find_class_usages(self, symbol: Symbol, lines: List[str], max_examples: int) -> List[Dict[str, Any]]:
    ...
    def _find_variable_usages(self, symbol: Symbol, lines: List[str], max_examples: int) -> List[Dict[str, Any]]:
