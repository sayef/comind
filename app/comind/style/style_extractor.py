...
class StyleExtractor:
    ...
    async def _analyze_typing(self, symbols: list[Symbol]):
        ...
        self.patterns.return_type_usage = PatternStats(count=return_typed, total=len(functions))
    ...
    async def _analyze_documentation(self, symbols: list[Symbol]):
        ...
        self.patterns.docstring_coverage = PatternStats(count=documented, total=len(functions))
    ...
    async def _analyze_async_usage(self, symbols: list[Symbol]):
        ...
        self.patterns.async_usage = PatternStats(count=async_count, total=len(functions))
